...
# Image data
keybinding_image_path = rospkg.RosPack().get_path("rover_arm") + ("/img/keybindings.png")
...
def main():
    ...
    sub_feedback = rospy.Subscriber("rover_arm_feedback", feedback, callback=feedback_callback)
