#ifndef _ROS_rover_mini_control_Encoder_h
#define _ROS_rover_mini_control_Encoder_h
...
namespace rover_mini_control
{
  ...
  class Encoder : public ros::Msg
  {
    ...
    Encoder():
      abs_enc_length(0), st_abs_enc(), abs_enc(nullptr),
      abs_enc_angles_length(0), st_abs_enc_angles(), abs_enc_angles(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "rover_mini_control/Encoder"; };
    virtual const char * getMD5() override { return "a664fd7d99f4f1ea35127a5719501f67"; };
