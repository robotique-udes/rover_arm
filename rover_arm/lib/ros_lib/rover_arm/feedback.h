#ifndef _ROS_rover_arm_feedback_h
#define _ROS_rover_arm_feedback_h
...
namespace rover_arm
{
  ...
  class feedback : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rover_arm/feedback"; };
    virtual const char * getMD5() override { return "7de36c7ef82cd2e0bdbddc6091336145"; };
