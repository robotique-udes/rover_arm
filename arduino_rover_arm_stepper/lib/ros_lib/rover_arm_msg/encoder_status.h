#ifndef _ROS_rover_arm_msg_encoder_status_h
#define _ROS_rover_arm_msg_encoder_status_h
...
namespace rover_arm_msg
{
  ...
  class encoder_status : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rover_arm_msg/encoder_status"; };
