#ifndef _ROS_rover_arm_msg_desired_joint_state_h
#define _ROS_rover_arm_msg_desired_joint_state_h
...
namespace rover_arm_msg
{
  ...
  class desired_joint_state : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rover_arm_msg/desired_joint_state"; };
